...
//void DW1000Device::setAddress(byte * deviceAddress) { memcpy(_ownAddress, deviceAddress, 8); }
...
void DW1000Device::setOtherRXPower(float RXPower){ _OtherRXPower=round(RXPower*100); }
...
//byte* DW1000Device::getByteAddress() { return _ownAddress; }
/*
...
float DW1000Device::getOtherRXPower(){ return float(_OtherRXPower)/100.0f; }
