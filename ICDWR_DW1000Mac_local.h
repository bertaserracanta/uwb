...
class DW1000Mac {
    public:
        ...
        //total=4 bytes
        void generateShortBlinkFrame(byte frame[], byte sourceShortAddress[]);
        ...
        void decodeShortBlinkFrame(byte frame[], byte shortAddress[]);
        void decodeBlinkFrame(byte frame[], byte address[], byte shortAddress[]);
        boolean decodeShortMACFrame(byte frame[], byte address[], byte destAdress[]);
