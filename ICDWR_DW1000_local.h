...
#define SLEEP_TIME_SHIFT 16
#define SLEEP_TIME_LEN 2

// PMSC
#define PMSC 0x36
#define PMSC_CTRL0_SUB 0x00
#define LEN_PMSC_CTRL0 4
#define PMSC_CTRL1_SUB 0x00
...
public:
  ...
  static void setAntennaDelay(unsigned short newDelay);
  static void writeAntennaDelay();
  ...
  static void resetCounter();
	...
	// reception state
	static void newReceive(bool clearStatus = true);
  ...
  static const byte MODE_IN_CIRCUIT_2[];
  static const byte MODE_IN_CIRCUIT_3[];
  static const byte MODE_IN_CIRCUIT_4[];
  static const byte MODE_IN_CIRCUIT_5[];
  static const byte MODE_IN_CIRCUIT_7[];
...
private:
  ...
  static unsigned int _antennaDelay;
